...
<body class="text-center">
    ...
    <div>
        ...
        <form method="post" action="statuscolaborador-salvar.php">
            <img class="mb-4" src="imagens/1.jpeg" alt="" width="300" height="150">
            <h1 class="h3 mb-3 fw-normal">Status do Colaborador</h1>

        <div class="form-floating mb-1">
          <input type="number" name="codstatcol" class= "form-control" id="floatingInput" placeholder="">
          <label for="floatingInput">Código</label>
        </div>

        <div class="form-floating mb-1">
          <input type="text" name="statcol" class="form-control" id="floatingPassword" placeholder="">
